...
import 'package:blinkit_clone/screens/FeedingIndiaProfilePage.dart';
import 'package:blinkit_clone/screens/PaymentsAndCouponsProfilePage.dart';
import 'package:blinkit_clone/screens/OtherInformationProfilePage.dart';
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 15),
              FeedingIndiaProfilePage(),
              SizedBox(height: 15),
              PaymentsAndCouponsProfilePage(),
              SizedBox(height: 15),
              OtherInformationProfilePage(),
              SizedBox(height: 25),
              ProfileEnd(),
            ],
          ),
